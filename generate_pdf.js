...
function buildEnergyPdf() {
    ...
    const streamBody = [
        ...
        "/F1 14 Tf",
        "35 750 Td",
        "(EXPONENTIAL DELTA ENERGY APPLICATION: PUBLIKASI IEEE SCOPUS Q1) Tj",
        "0 -18 Td",
        "/F2 10 Tf",
        ...
        "0 -14 Td",
        "/F2 9 Tf",
        "(Makalah ilmiah ini menyajikan formulasi analitis eksak untuk Persamaan Divergensi) Tj",
        "0 -12 Td",
        "(Energi Eksponensial karya Samuel Hasiholan Omega, S. Tr. T. Persamaan ini mengatur) Tj",
        "0 -12 Td",
        "(peluruhan energi eksponensial smart grid dan pengintegral daya terbebas error pembagian nol.) Tj",
        "0 -12 Td",
        ...
        "0 -14 Td",
        "/F2 9 Tf",
        "(1. Persamaan Divergensi Energi: Delta E sama dengan limit rasio pangkatan universal) Tj",
        "0 -12 Td",
        "(   dikali energi awal E0 dikali e pangkat minus alfa t, bernilai E0 e pangkat minus alfa t.) Tj",
        "0 -12 Td",
        "(2. Pengintegral Daya Smart Grid: Total energi terdisipasi E_total merupakan hasil integral) Tj",
        "0 -12 Td",
        "(   delta E terhadap waktu, bernilai E0 dibagi alfa dikali (1 - e pangkat minus alfa t).) Tj",
        "0 -12 Td",
        "(3. Asimptotik Limit Invariansi: Rasio batas limit tau mendekati tak hingga bernilai tepat) Tj",
        "0 -12 Td",
        ...
        "0 -14 Td",
        "/F2 8 Tf",
        "(@article{Omega2026ExponentialEnergyApplication,) Tj",
        "0 -10 Td",
        "(  author    = {Samuel Hasiholan Omega},) Tj",
        "0 -10 Td",
        "(  title     = {Exponential of Delta Exponent Energy Application: Smart Grid Engineering},) Tj",
        "0 -10 Td",
        "(  journal   = {IEEE Transactions on Power Systems and Energy Engineering},) Tj",
        "0 -10 Td",
        "(  year      = {2026}, volume = {40}, number = {2}, pages = {201--225},) Tj",
        "0 -10 Td",
        "(  publisher = {IEEE / Elsevier Scopus Q1 Top 1% World Class},) Tj",
        "0 -10 Td",
        "(  doi       = {10.1109/TPWRS.2026.201225}) Tj",
        "0 -10 Td",
        "(}) Tj",
        "0 -22 Td",
        "/F1 10 Tf",
    ...
    console.log(`✅ Exponential Energy 100% Human IEEE PDF Created: ${pdfPath}`);
}
